  ...
  return (
    <div className="card text-center group animate-scale-in">
      <div className="flex justify-center mb-4">
        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent/10 to-accent-teal/10 flex items-center justify-center text-accent-teal group-hover:from-accent/25 group-hover:to-accent-teal/25 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 relative">
