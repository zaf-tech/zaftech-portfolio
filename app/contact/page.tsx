            ...
            <div className="card">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-xs text-center text-text-light mt-2">
                  Protected by reCAPTCHA v3. <a href="https://policies.google.com/privacy" target="_blank" rel="noopener" className="text-accent-teal hover:underline">Privacy</a> & <a href="https://policies.google.com/terms" target="_blank" rel="noopener" className="text-accent-teal hover:underline">Terms</a>
                </p>
              </form>
            </div>
          </div>
