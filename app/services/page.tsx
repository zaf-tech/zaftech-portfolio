export const metadata = {
  title: "Data Science & AI Services - Zaftech",
  description:
    "Custom machine learning models, predictive analytics, data engineering, and AI-powered solutions. End-to-end data science services for business transformation.",
};
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-xl md:text-2xl text-text-light max-w-2xl mx-auto leading-relaxed">
                From data strategy to production ML models—comprehensive solutions to drive data-driven transformation
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-3xl mx-auto">
              <div className="text-center p-6 rounded-xl bg-white/60 backdrop-blur-sm border border-gray-100">
                ...
                <div className="text-sm text-text-light">Data Science Services</div>
              </div>
              <div className="text-center p-6 rounded-xl bg-white/60 backdrop-blur-sm border border-gray-100">
                <div className="text-2xl font-heading font-bold text-accent-teal mb-2">
                  weeks
                </div>
                <div className="text-sm text-text-light">From Strategy to Production</div>
              </div>
              <div className="text-center p-6 rounded-xl bg-white/60 backdrop-blur-sm border border-gray-100">
                <div className="text-2xl font-heading font-bold text-accent-teal mb-2">
                  95%+
                </div>
                <div className="text-sm text-text-light">Model Accuracy</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="text-text-light mb-4 leading-relaxed">
                  Define your data maturity roadmap and build a data-driven culture. We help organizations identify high-impact ML use cases and create strategic data initiatives aligned with business goals.
                </p>
                <p className="text-text-light mb-4 leading-relaxed">
                  Our consulting services cover data assessment, competitive analysis, technology selection, and roadmapping to accelerate your digital transformation journey.
                </p>
                ...
                <p className="text-text-light mt-4 leading-relaxed">
                  <strong>Who It's For:</strong> Organizations looking to establish a data-driven culture and develop a strategic approach to AI and machine learning investments.
                </p>
              </div>
              <div className="bg-gray-50 rounded-xl p-8 h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-text-light">Data Strategy</p>
                </div>
              </div>
            </div>
          </div>
